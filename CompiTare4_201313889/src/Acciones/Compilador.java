...
public class Compilador 
{
      ...
      public void Analizar(String entrada, JTextPane consola)
    {
        ...
        {
            //crear el lexico
            Lexico1 lexico = new Lexico1(new StringReader(entrada));
            //crear el sintactico
            Parser1 parser = new Parser1(lexico);
            
            //ejecutar el analisis
            parser.parse();
                                    
            JOptionPane.showMessageDialog(null, "Analisis Completo","Tarea 4 AST",1);
        ...
        catch (Exception ex) 
        {
            ...
            JOptionPane.showMessageDialog(null, "Ocurrio un grave problema","Tarea 4 AST",2);
        }        
    }
